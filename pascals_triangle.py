...
Time Complexity: O(n^2) - where n if the number of rows. The function makes n
                          ...
                          depending on the number of elements in that row which is n for the last row
...
Space Complexity: O(n^2) - Since we store a list of each row of the pascal triangle,
                           ...
                           Therefore, space required is num_rows ^2. The recursive call stack is O(num_rows)
